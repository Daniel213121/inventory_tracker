...
function mkUnits(itemId: string, serials: string[], condition: ConditionValue, purchaseDate: string, updated: string): SerialUnit[] {
...
export const INVENTORY: InventoryItem[] = [
  {
    ...
    isSerialised: true,
    serialUnits: mkUnits('i01', ['WX12D8KP3RA1','WX12D8KP3RA2','WX12D8KP3RA3','WX12D8KP3RA4','WX12D8KP3RA5','WX12D8KP3RA6','WX12D8KP3RA7','WX12D8KP3RA8','WX12D8KP3RA9','WX12D8KP3RB1','WX12D8KP3RB2','WX12D8KP3RB3'], 'NEW', '2026-03-12', '2026-05-18'),
    qtyNew: 12, qtyUsed: 0, qtyFaulty: 0, quantity: 12, threshold: 5, imageUrl: null,
  ...
  },
  {
    ...
    isSerialised: true,
    serialUnits: mkUnits('i02', ['ZL2A87NHQ0','ZL2A87NHQ1','ZL2A87NHQ2','ZL2A87NHQ3','ZL2A87NHQ4','ZL2A87NHQ5'], 'NEW', '2026-02-04', '2026-05-11'),
    qtyNew: 6, qtyUsed: 0, qtyFaulty: 0, quantity: 6, threshold: 4, imageUrl: null,
  ...
  },
  {
    ...
    isSerialised: true,
    serialUnits: mkUnits('i03', ['S6PUNS0T901442','S6PUNS0T901443','S6PUNS0T901444','S6PUNS0T901445','S6PUNS0T901446'], 'NEW', '2026-04-22', '2026-05-19'),
    qtyNew: 5, qtyUsed: 0, qtyFaulty: 0, quantity: 5, threshold: 2, imageUrl: null,
  ...
  },
  {
    ...
    isSerialised: true,
    serialUnits: mkUnits('i04', ['50026B7785A21CB1','50026B7785A21CB2','50026B7785A21CB3','50026B7785A21CB4'], 'NEW', '2026-01-30', '2026-05-09'),
    qtyNew: 4, qtyUsed: 0, qtyFaulty: 0, quantity: 4, threshold: 2, imageUrl: null,
  ...
  },
  {
    ...
    isSerialised: true,
    serialUnits: mkUnits('i05', ['DLLR650-7HX9P2','DLLR650-8KY3Q1'], 'NEW', '2025-11-15', '2026-04-29'),
    qtyNew: 2, qtyUsed: 0, qtyFaulty: 0, quantity: 2, threshold: 1, imageUrl: null,
  ...
  },
  {
    ...
    isSerialised: true,
    serialUnits: mkUnits('i06', ['DLLT440-RF02JK'], 'USED', '2024-08-02', '2026-04-15'),
    qtyNew: 0, qtyUsed: 1, qtyFaulty: 0, quantity: 1, threshold: 1, imageUrl: null,
  ...
  },
  {
    ...
    isSerialised: true,
    serialUnits: mkUnits('i07', ['FOC2410L5N8','FOC2410L5N9','FOC2410L5NA','FOC2410L5NB'], 'NEW', '2025-12-10', '2026-05-01'),
    qtyNew: 4, qtyUsed: 0, qtyFaulty: 0, quantity: 4, threshold: 2, imageUrl: null,
  ...
  },
  {
    ...
    isSerialised: true,
    serialUnits: mkUnits('i08', ['F4920A1B7C03','F4920A1B7C04','F4920A1B7C05'], 'NEW', '2026-03-25', '2026-05-17'),
    qtyNew: 3, qtyUsed: 0, qtyFaulty: 0, quantity: 3, threshold: 6, imageUrl: null,
  ...
  },
  {
    ...
    isSerialised: false, serialUnits: [],
    qtyNew: 8, qtyUsed: 0, qtyFaulty: 0, quantity: 8, threshold: 3, imageUrl: null,
  ...
  },
  {
    ...
    isSerialised: true,
    serialUnits: mkUnits('i10', ['HKV7716-K4-22B8','HKV7716-K4-22B9','HKV7716-K4-22C0','HKV7716-K4-22C1','HKV7716-K4-22C2'], 'NEW', '2026-02-18', '2026-05-08'),
    qtyNew: 5, qtyUsed: 0, qtyFaulty: 0, quantity: 5, threshold: 2, imageUrl: null,
  ...
  },
  {
    ...
    isSerialised: true,
    serialUnits: mkUnits('i11', ['FGT60FTK22018A45','FGT60FTK22018A46','FGT60FTK22018A47','FGT60FTK22018A48','FGT60FTK22018A49','FGT60FTK22018A50'], 'NEW', '2026-01-22', '2026-05-15'),
    qtyNew: 6, qtyUsed: 0, qtyFaulty: 0, quantity: 6, threshold: 3, imageUrl: null,
  ...
  },
  {
    ...
    isSerialised: true,
    serialUnits: mkUnits('i12', ['MXQ410028L','MXQ410028M'], 'NEW', '2025-10-05', '2026-04-30'),
    qtyNew: 2, qtyUsed: 0, qtyFaulty: 0, quantity: 2, threshold: 1, imageUrl: null,
  ...
  },
  {
    ...
    isSerialised: true,
    serialUnits: mkUnits('i13', ['2317E76A0F1D','2317E76A0F1E','2317E76A0F1F','2317E76A0F20','2317E76A0F21'], 'NEW', '2026-03-08', '2026-05-10'),
    qtyNew: 5, qtyUsed: 0, qtyFaulty: 0, quantity: 5, threshold: 2, imageUrl: null,
  ...
  },
  {
    ...
    isSerialised: true,
    serialUnits: mkUnits('i14', ['23496A11DCFE','23496A11DCFF','23496A11DD00','23496A11DD01'], 'NEW', '2026-04-12', '2026-05-18'),
    qtyNew: 4, qtyUsed: 0, qtyFaulty: 0, quantity: 4, threshold: 2, imageUrl: null,
  ...
  },
  {
    ...
    isSerialised: true,
    serialUnits: mkUnits('i15', ['Y2H0A3CMF95G','Y2H0A3CMF95H','Y2H0A3CMF95I','Y2H0A3CMF95J'], 'NEW', '2026-02-26', '2026-05-02'),
    qtyNew: 4, qtyUsed: 0, qtyFaulty: 0, quantity: 4, threshold: 2, imageUrl: null,
  ...
  },
  {
    ...
    isSerialised: false, serialUnits: [],
    qtyNew: 1, qtyUsed: 0, qtyFaulty: 0, quantity: 1, threshold: 10, imageUrl: null,
  ...
  },
  {
    ...
    isSerialised: true,
    serialUnits: mkUnits('i17', ['DLL5550-9PXQ7R','DLL5550-9PXQ7S','DLL5550-9PXQ7T'], 'USED', '2024-09-19', '2026-04-22'),
    qtyNew: 0, qtyUsed: 3, qtyFaulty: 0, quantity: 3, threshold: 2, imageUrl: null,
  ...
  },
  {
    ...
    isSerialised: true,
    serialUnits: mkUnits('i18', ['Q5XB-7K9R-W2NM'], 'FAULTY', '2025-06-11', '2026-05-05'),
    qtyNew: 0, qtyUsed: 0, qtyFaulty: 1, quantity: 1, threshold: 2, imageUrl: null,
  ...
  },
  {
    ...
    brand: 'Samsung', model: 'MZ-77E1T0B/AM',
    isSerialised: true,
    serialUnits: mkUnits('i19', ['SAM-870-EVO-001','SAM-870-EVO-002','SAM-870-EVO-003','SAM-870-EVO-004','SAM-870-EVO-005'], 'NEW', '2026-05-15', '2026-05-15'),
    qtyNew: 5, qtyUsed: 0, qtyFaulty: 0, quantity: 5, threshold: 2, imageUrl: null,
  ...
  },
  {
    ...
    isSerialised: false, serialUnits: [],
    qtyNew: 6, qtyUsed: 0, qtyFaulty: 0, quantity: 6, threshold: 2, imageUrl: null,
...
export const MOVEMENTS: Movement[] = [
  {
    id: 'm01', itemId: 'i01', itemName: 'WD Red Plus 8TB NAS HDD', itemIsSerialised: true,
    companyId: 'vsa', companyCode: 'VSA', type: 'OUT', quantity: 4,
    ...
    driverName: 'Kojo Mensah', notes: 'Phase 1 NVR rebuild', waybillId: 'w01', waybillNumber: 'VSA/TGB/2026/02',
    movedBy: 'Akua Sarpong', movedAt: '2026-05-18T09:14:00',
  },
  {
    id: 'm02', itemId: 'i03', itemName: 'Samsung 870 EVO 1TB SATA SSD', itemIsSerialised: true,
    companyId: 'vsa', companyCode: 'VSA', type: 'OUT', quantity: 5,
  ...
  {
    id: 'm03', itemId: 'i11', itemName: 'Fortinet FortiGate 60F Firewall', itemIsSerialised: true,
    companyId: 'via', companyCode: 'VIA', type: 'OUT', quantity: 2,
    serialsDispatched: ['FGT60FTK22018A45','FGT60FTK22018A46'],
    condBefore: 'NEW', condAfter: 'NEW',
    suppliedTo: 'Stanbic Bank — Airport City', destinationCode: 'STB',
    driverName: 'Ibrahim Mohammed', notes: 'Branch FW refresh', waybillId: 'w02', waybillNumber: 'VIA/STB/2026/01',
    movedBy: 'Akua Sarpong', movedAt: '2026-05-17T14:42:00',
  },
  {
    id: 'm04', itemId: 'i07', itemName: 'Cisco Catalyst 2960-X 48-port', itemIsSerialised: true,
    companyId: 'vsa', companyCode: 'VSA', type: 'OUT', quantity: 1,
    serialsDispatched: ['FOC2410L5N8'],
    condBefore: 'NEW', condAfter: 'NEW',
    suppliedTo: 'MTN Ghana — Ridge Tower', destinationCode: 'MTN',
    driverName: 'Yaw Asare', notes: '', waybillId: 'w03', waybillNumber: 'VSA/MTN/2026/01',
    movedBy: 'Daniel Owusu', movedAt: '2026-05-16T11:08:00',
  },
  {
    id: 'm05', itemId: 'i14', itemName: 'WD Black SN850X 2TB NVMe', itemIsSerialised: true,
    companyId: 'via', companyCode: 'VIA', type: 'OUT', quantity: 4,
    ...
    driverName: 'Ibrahim Mohammed', notes: 'Workstation upgrade', waybillId: 'w04', waybillNumber: 'VIA/ECO/2026/01',
    movedBy: 'Akua Sarpong', movedAt: '2026-05-15T15:30:00',
  },
  {
    id: 'm06', itemId: 'i05', itemName: 'Dell PowerEdge R650', itemIsSerialised: true,
    companyId: 'vsa', companyCode: 'VSA', type: 'OUT', quantity: 1,
    serialsDispatched: ['DLLR650-7HX9P2'],
    condBefore: 'NEW', condAfter: 'NEW',
    suppliedTo: 'Ghana Revenue Authority', destinationCode: 'GRA',
    driverName: 'Yaw Asare', notes: 'SOC pilot', waybillId: 'w05', waybillNumber: 'VSA/GRA/2026/01',
    movedBy: 'Daniel Owusu', movedAt: '2026-05-14T10:00:00',
  },
  {
    id: 'm07', itemId: 'i12', itemName: 'HPE ProLiant DL380 Gen11', itemIsSerialised: true,
    companyId: 'via', companyCode: 'VIA', type: 'OUT', quantity: 1,
    serialsDispatched: ['MXQ410028L'],
    condBefore: 'NEW', condAfter: 'NEW',
    suppliedTo: 'Ghana Revenue Authority', destinationCode: 'GRA',
    driverName: 'Yaw Asare', notes: 'SOC pilot', waybillId: 'w06', waybillNumber: 'VIA/GRA/2026/01',
    movedBy: 'Daniel Owusu', movedAt: '2026-05-14T10:05:00',
  },
  {
    id: 'm08', itemId: 'i09', itemName: 'Logitech MK540 Wireless Combo', itemIsSerialised: false,
    companyId: 'vsa', companyCode: 'VSA', type: 'OUT', quantity: 6,
    serialsDispatched: [],
    condBefore: 'NEW', condAfter: 'NEW',
    suppliedTo: 'TG Bank — Tema Branch', destinationCode: 'TGB',
    driverName: 'Kojo Mensah', notes: 'End-user kits', waybillId: 'w07', waybillNumber: 'VSA/TGB/2026/01',
    movedBy: 'Akua Sarpong', movedAt: '2026-05-13T09:50:00',
  },
  {
    id: 'm09', itemId: 'i01', itemName: 'WD Red Plus 8TB NAS HDD', itemIsSerialised: true,
    companyId: 'vsa', companyCode: 'VSA', type: 'IN', quantity: 12,
    serialsDispatched: [],
    condBefore: null, condAfter: 'NEW',
    suppliedTo: 'Compu-Ghana Ltd (PO 4421)', destinationCode: null,
    driverName: 'Compu-Ghana Logistics', notes: 'Restock', waybillId: null, waybillNumber: null,
    movedBy: 'Daniel Owusu', movedAt: '2026-05-12T08:30:00',
  },
  {
    id: 'm10', itemId: 'i06', itemName: 'Dell PowerEdge T440 (refurb)', itemIsSerialised: true,
    companyId: 'vsa', companyCode: 'VSA', type: 'IN', quantity: 1,
    serialsDispatched: [],
    condBefore: 'NEW', condAfter: 'USED',
    suppliedTo: 'MTN Ghana — return', destinationCode: null,
    driverName: 'Yaw Asare', notes: 'Returned after deployment, needs inspection', waybillId: null, waybillNumber: null,
    movedBy: 'Daniel Owusu', movedAt: '2026-05-11T16:18:00',
  },
  {
    id: 'm11', itemId: 'i18', itemName: 'Cisco Meraki MR46 AP', itemIsSerialised: true,
    companyId: 'via', companyCode: 'VIA', type: 'IN', quantity: 1,
    serialsDispatched: [],
    condBefore: 'NEW', condAfter: 'FAULTY',
    suppliedTo: 'Stanbic Bank — return', destinationCode: null,
    driverName: 'Ibrahim Mohammed', notes: 'PoE issue, RMA pending', waybillId: null, waybillNumber: null,
    movedBy: 'Akua Sarpong', movedAt: '2026-05-05T13:22:00',
  },
  {
    id: 'm12', itemId: 'i08', itemName: 'Ubiquiti UniFi 6 LR Access Point', itemIsSerialised: true,
    companyId: 'vsa', companyCode: 'VSA', type: 'IN', quantity: 6,
    serialsDispatched: [],
    condBefore: null, condAfter: 'NEW',
    suppliedTo: 'Compu-Ghana Ltd (PO 4413)', destinationCode: null,
    driverName: 'Compu-Ghana Logistics', notes: 'Restock APs', waybillId: null, waybillNumber: null,
    movedBy: 'Daniel Owusu', movedAt: '2026-05-02T10:11:00',
  },
  {
    id: 'm13', itemId: 'i16', itemName: 'Yubikey 5 NFC Hardware Token', itemIsSerialised: false,
    companyId: 'via', companyCode: 'VIA', type: 'IN', quantity: 10,
    serialsDispatched: [],
    condBefore: null, condAfter: 'NEW',
    suppliedTo: 'Yubico EU (DHL)', destinationCode: null,
    driverName: 'DHL Express', notes: 'Tokens for analyst onboarding', waybillId: null, waybillNumber: null,
